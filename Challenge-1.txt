# Pokedex Challenge
Este desafío tiene como objetivo plasmar tus habilidades como desarrollador frontend. Es sin límite de tiempo y en caso de tener consultas no dudes en contactarnos.
En cuanto lo recibamos, trataremos de darte feedback lo antes posible, pero en ocasiones podríamos demorarnos hasta una semana.
...
Utilizar la [pokéapi](https://pokeapi.co/docs/v2.html) para mostrar un listado de pokémons
   ...
   - permitir hacer click y ver detalle del pokémon
       - habilidades (con sus descripciones) e imagen del pokemón.
